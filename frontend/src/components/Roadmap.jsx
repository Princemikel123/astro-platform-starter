...
const phases = [
  {
    ...
    borderColor: "#39FF14",
    items: [
      { num: 1, icon: Sprout, text: "Birth of the Sloth" },
      { num: 2, icon: Users, text: "The Sloth Squad Gathers" },
  ...
  },
  {
    ...
    items: [
      ...
      { num: 8, icon: Heart, text: "Sloth Conservation Fund" },
    ],
  },
  {
    title: "Phase C",
    subtitle: "THE SLOTH TAKEOVER",
  ...
  },
  {
    ...
    items: [
      ...
      { num: 16, icon: Rocket, text: "Sloth on the Moon!" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-['Anton'] text-4xl sm:text-5xl tracking-tight uppercase text-white">
            The Official <span className="text-[#39FF14]">SlothMap</span>
          </h2>
